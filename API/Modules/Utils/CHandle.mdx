...
```csharp
public class CHandle  where T : NativeObject
{
...
```csharp
public static implicit operator T(CHandle  handle)  // 从句柄到实体的隐式转换
public static implicit operator CHandle (T entity)  // 从实体到句柄的隐式转换
```
